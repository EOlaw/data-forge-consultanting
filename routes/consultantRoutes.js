...
router.route('/')
    .post(isAuthenticated, isAuthorizedAsConsultant, consultantControllers.createConsultant)
    .get(isAuthenticated, isAuthorizedAsConsultant, consultantControllers.getConsultants);
